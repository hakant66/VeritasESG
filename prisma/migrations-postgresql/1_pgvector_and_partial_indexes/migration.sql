-- Engine-specific objects that cannot be expressed in schema.prisma. Applied on
-- a PostgreSQL core (or the Postgres vector sidecar) after the baseline schema:
